...
<div class="pagetitle">
  <h1>Diagram Bulanan</h1>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="tabel-admin">Charts</a></li>
...
<section class="section">
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Diagram Penjualan per Bulan</h5>
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title" margin="center">Tabel Penjualan</h5>

              <!-- Column Chart -->
              <div id="columnChart">
              <script margin="center">
                document.addEventListener("DOMContentLoaded", () => {
                  new ApexCharts(document.querySelector("#columnChart"), {
                    series: [{
                      name: 'Pembayaran',
                      data: [10, 20, 15, 26, 25, 22, 15, 10, 14, 18, 20, 30]
                    // }, {
                    //   name: 'Revenue',
