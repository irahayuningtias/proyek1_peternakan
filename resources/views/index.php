...
<head>
  ...
  <title>Dashboard - Peternakan Ayam Maju Jaya</title>
...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="charts">
              <i class="bi bi-circle"></i><span>Laporan Bagan </span>
            </a>
          </li>
          <!--<li>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Peternakan Ayam Maju Jaya</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
